        ...
        <div className="flex flex-col gap-4">
            <div className="flex flex-col gap-0">
                <div className="flex items-center justify-start gap-2">
                    <GlobeSVG />
                    <h1 className="text-xl text-white font-semibold">Seed Analysis Tool</h1>
                </div>
                <p className="text-xs text-gray-400 leading-3.5 font-medium">
                    by students at Imperial College London
                </p>
            </div>
            {/* <p className="text-sm text-gray-50 leading-5 font-medium">
                Upload an image of a batch of seeds to analyse the quality of the batch.
            </p> */}
        </div>
    );
}
